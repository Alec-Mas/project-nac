...
<div class="card mb-3">
    <div class="card-header pb-0">
        <p class="pb-0" style="float:left;"><i class="fa fa-hand-spock-o"></i> Welcome, {{ Auth::user()->name}}</p>
        <p class="pb-0" style="float:right">{{Auth::user()->roles()->pluck('name')->implode(' ')}}</p>
    </div>
    <div class="card-body">
